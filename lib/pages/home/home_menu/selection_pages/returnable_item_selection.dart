...
class ReturnableItemSelection extends StatefulWidget {
  const ReturnableItemSelection({super.key});

  @override
  State<ReturnableItemSelection> createState() =>
      _ReturnableItemSelectionState();
}

class _ReturnableItemSelectionState extends State<ReturnableItemSelection> {
  //dialog box controllers
  final TextEditingController _returnQtyController = TextEditingController();
  final TextEditingController _reasonController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    final String grnId = ModalRoute.of(context)!.settings.arguments as String;
    return Scaffold(
