...
class _SalesOrderState extends State<SalesOrder> {
  final _soStream =
      FirebaseFirestore.instance.collection('sales_orders').snapshots();
        ...
        floatingActionButton:
            permissionProvider.hasPermission('manage_so')
                ? FloatingActionButton(
                  ...
                  foregroundColor: Colors.white,
                  onPressed: () {
                    Navigator.pushNamed(context, '/createso');
                  },
                  ...
                  switch (_sorted) {
                    ...
                    case 0:
                      salesOrders.sort((a, b) {
                        final nameA = a['customerName']?.toString() ?? '';
                        final nameB = b['customerName']?.toString() ?? '';
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          DateFormat('MMMM d, yyyy').format(
                                            DateTime.parse(so['expectedDate']),
                                          ),
                                          style: TextStyle(
                                            fontSize: 13,
